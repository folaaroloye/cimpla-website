    ...
    <div className="flex flex-wrap items-center justify-between px-20 py-6 w-full">
      ...
      <div className="flex items-center">
        <ul className="flex flex-col font-medium p-4 md:p-0 mt-4 border border-gray-100 rounded-lg bg-gray-50 md:space-x-8 rtl:space-x-reverse md:flex-row md:mt-0 md:border-0 md:bg-white dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700">
          <li className="font-normal text-primary-200 text-h8 cursor-pointer w-[100px]">About Us</li>
          <li className="font-normal text-primary-200 text-h8 cursor-pointer w-[100px]">Product</li>
          <li className="font-normal text-primary-200 text-h8 cursor-pointer w-[100px]">Contact Us</li>
        </ul>
